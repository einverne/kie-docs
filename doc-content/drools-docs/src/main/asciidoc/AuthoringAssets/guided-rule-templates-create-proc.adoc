...
你可以使用 guided rule templates 使用占位符来定义规则结构。Guided rule templates 是定义一组相同结构的规则的可选方案，用定义的模板可以快速生成相似的规则。

.Procedure 流程
. In {CENTRAL}, go to *Menu* -> *Design* -> *Projects* and click the project name.
. Click *Add Asset* -> *Guided Rule Template(规则模板)*.
